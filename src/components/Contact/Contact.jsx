...
const socialLinks = [
  ...
  },
  {
    name: 'LinkedIn',
    id: 'linkedin',
    url: 'https://www.linkedin.com/in/shandy-alfarizy-1641252b2/',
    icon: (
      <svg width="22" height="22" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
  ...
  },
  {
    name: 'Discord',
    id: 'discord',
    url: 'https://discord.com/users/aparijiy',
    icon: (
      <svg width="22" height="22" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
  ...
  return (
    <section className={`contact ${revealed ? 'contact--visible' : ''}`} id="contact" ref={revealRef}>
      ...
      <div className="contact-content container">
        ...
        {/* Contact Split Layout: Editorial Underline Form + Minimal Social List */}
        <div className="contact-split-layout">
            ...
            <form className="contact-form" onSubmit={handleSubmit} noValidate>
              <div className="form-group">
                ...
                <div className="input-underline-wrapper">
                  ...
                  />
                  <span className="input-focus-draw" />
                </div>
              ...
              <div className="submit-btn-wrapper">
                ...
                >
                  ...
                  {status.type !== 'loading' && (
                    <svg className="submit-arrow" width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round">
                      <path d="M5 12h14M12 5l7 7-7 7" />
                    </svg>
                  )}
                  <span className="btn-underline-draw" />
                </button>
              </div>
            </form>
          </div>
          ...
          >
            ...
            <div className="editorial-social-list">
              {socialLinks.map((link, idx) => (
                <div
                  key={link.name}
                  className={`editorial-social-item ${revealed ? 'is-revealed' : ''}`}
                  data-reveal="fast"
                ...
                >
                  <a
                    ...
                    id={`contact-${link.id}`}
                  >
                    <div className="social-left-group">
                      <span className="social-icon-fade">{link.icon}</span>
                      <span className="social-name">{link.name}</span>
                    </div>
                    <svg className="social-arrow" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true">
